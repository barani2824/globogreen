...
public class UserService {
    ...
    private final PersonalDetailsRepository personalDetailRepository;
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository, CacheManager cacheManager, PersonalDetailsRepository personalDetailRepository) {
    ...
    public PersonalDetails saveDetails(PersonalDetails p){
     return   this.personalDetailRepository.save(p);
    }
